...
public:
	...
	/**
	 * \brief Execute the line as if it was sent by the widget.
	 * 
	 * Using this, you can simulate a line execution.
	 */
	void executeLine(const QString &line);

	/**
	 * \brief Simulate executing the line, but don't call the slot.
	 * 
	 * Use this to add the line to the history.
	 */
	void simulateExecuteLine(const QString &line);
